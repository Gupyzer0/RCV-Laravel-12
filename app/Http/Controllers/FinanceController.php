   ...
   public function sumTotalPremiumByType(Request $request)
    {
        ...
        $sumAndCountByType = $query->get()->map(function ($item) {
            ...
            switch ($item->type) {
                case 1: $item->type_name = 'Eduardo Ortega'; break;
                case 2: $item->type_name = 'Oriana Silva'; break;
                case 3: $item->type_name = 'Jesus Silva'; break;
                case 4: $item->type_name = 'Petter Diaz'; break;
                case 5: $item->type_name = 'Lexaida'; break;
                case 6: $item->type_name = 'Juan Carlos'; break;
                case 7: $item->type_name = 'Dorys Ramirez'; break;
                case 8: $item->type_name = 'Richard Gomez'; break;
                case 9: $item->type_name = 'Jesus Anuel'; break;
                default: $item->type_name = 'Otro tipo'; break;
            }
            return $item;
        });
    ...
    public function exportSummaryPdf(Request $request)
    {
        ...
        $sumAndCountByType = $query->get()->map(function ($item) {
            switch ($item->type) {
                case 1: $item->type_name = 'Eduardo'; break;
                case 2: $item->type_name = 'Oriana'; break;
                case 3: $item->type_name = 'Liliana'; break;
                case 4: $item->type_name = 'Anais'; break;
                case 5: $item->type_name = 'Lexaida'; break;
                case 6: $item->type_name = 'David'; break;
                case 7: $item->type_name = 'Juan Carlos'; break;
                case 8: $item->type_name = 'Alex'; break;
                default: $item->type_name = 'Otro tipo'; break;
            }
            return $item;
        });
