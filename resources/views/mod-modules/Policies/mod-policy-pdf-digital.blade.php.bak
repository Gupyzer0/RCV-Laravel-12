...
<body>
    ...
    <div id="watermark">
        ...
        <table width="100%" border="0" align="center" style="margin-top: 40px; border:none;" cellspacing="0" bordercolor="#000000" class="borde" >
            ...
            <tr>
              ...
              @if($policy->idp)
              <td><strong>Poliza N°: </strong><i>{{$policy->idp}}</i></td>
               @else
...
<div class="page_break" >
    <div id="watermark">
            <img src="{{asset('images/hoja3.jpg')}}" height="100%" width="100%" />
    </div>
</div>
</body>
</html>
