...
<div>
    ...
    <p class="pr">
        ...
        Es oportuno darle una cordial bienvenida como Aliado a: <strong>{{ $user->office->office_address }}</strong>  teniendo como Represéntate legal:  a <strong>{{ $user->name.' '.$user->lastname }}</strong> titular de la cedula de identidad enmarcado con el numero <strong>{{ $user->ci }},</strong> domiciliado en el
