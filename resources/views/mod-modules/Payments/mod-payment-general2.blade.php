...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<div class="table-responsive">
			<div class="card-header py-2">
                @if(isset($user))
                <form action="{{ route('mod.vendedor.seach1') }}" method="GET" style="display: inline;">
                ...
                @endif
                <div class="fomf">
                    <form class="form-inline d-flex align-items-center" method="GET" name="formFechas" id="formFechas" action="{{ route('mod.vendedor.seach1') }}">
                        ...
                        <div class="form-group mx-2">
                            <a class="btn btn-primary" href="{{ route('mod.general.payments') }}">Limpiar</a>
                        </div>
                    </form>
                </div>
            </div>
