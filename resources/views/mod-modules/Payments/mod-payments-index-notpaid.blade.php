...
<div class="card shadow mb-4">
    ...
    <nav class="navbar navbar-light" style="text-align: right">
        ...
        {{-- <form class="form-inline" action="{{ route('index.notpaid') }}" method="GET">
            <input autocomplete="off" list="lista" type="text" name="users" class="form-control"
        ...
        <form class="form-inline" action="{{ route('index.notpaid') }}" method="GET">
            <input autocomplete="off" list="listamod" type="text" name="moderator" class="form-control"
                    ...
                    @foreach($users as $user)
                        ...
                        @if($policySummary['notPaidCount'] > 0)
                            <tr>
                                ...
                                @php
                                    $profit = PaymentsController::profit_percentage($policySummary['totalNotPaidPrice'],
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3">
                                            ...
                                            <a class="dropdown-item" href="{{ route('moderador.pagos.pendientes-por-usuario', $user) }}">Pagar</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> <strong class="text-danger">Realizar Cierre</strong>
                </h5>
