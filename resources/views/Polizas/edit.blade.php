...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form action="{{ route('polizas.update', $poliza) }}" method="POST" enctype="multipart/form-data"  id="form_policies">
			@csrf
			...
			<div class="form-row border-bottom border-dark">
				...
				<div class="form-group col-md-3">
					...
					<input  autocomplete="off" type="text" maxlength="40" name="client_name_contractor" id="client_name_contractor" class="form-control @error('client_name_contractor') is-invalid @enderror"  value="{{ $poliza->client_name_contractor }}">
                ...
                <div class="form-group col-md-3">
					...
					<input autocomplete="off" type="text" name="client_lastname_contractor" id="client_lastname_contractor" class="form-control @error('client_lastname_contractor') is-invalid @enderror" value="{{$poliza->client_lastname_contractor}}">
			...
			<div class="form-row border-bottom border-dark">
				...
				<div class="form-group col-md-3">
					...
					<input  autocomplete="off" type="text" maxlength="40" name="client_name" id="client_name" class="form-control @error('client_name') is-invalid @enderror" value="{{ $poliza->client_name }}">
                ...
                <div class="form-group col-md-3">
					...
					<input autocomplete="off" type="text" name="client_lastname" id="client_lastname" class="form-control @error('client_lastname') is-invalid @enderror" value="{{ $poliza->client_lastname }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input  autocomplete="off" type="email" maxlength="40" name="client_email" id="client_email" class="form-control @error('client_email') is-invalid @enderror" placeholder="..." value="{{ $poliza->client_email }}">
				...
				<div class="form-group col-md-3">
					...
					<input  type="date" name="fecha_n" id="fecha_n" class="form-control @error('fecha_n') is-invalid @enderror" value="{{ $poliza->fecha_n }}">
                ...
                <div class="form-group col-md-3">
					...
					<select name="estadocivil" id="estadocivil" class="form-control @error('estadocivil') is-invalid @enderror custom-select">
                        <option value="{{$poliza->estadocivil}}">{{$poliza->estadocivil}}</option>
                ...
                <div class="form-group col-md-3">
					...
					<select name="genero" id="genero" class="form-control @error('genero') is-invalid @enderror custom-select" >
                        <option value="{{$poliza->genero}}">{{$poliza->genero}}</option>
				...
				<div class="form-group col-md-3">
					...
					<select name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror custom-select">
						<option value="{{$poliza->id_estado}}">{{$poliza->estado->estado}}</option>
				...
				<div class="form-group col-md-3">
					...
					<select name="municipio" id="municipio" class="form-control @error('municipio') is-invalid @enderror custom-select">
						<option value="{{$poliza->id_municipio}}">{{$poliza->municipio->municipio}}</option>
					</select>
				...
				<div class="form-group col-md-3">
					...
					<select  name="parroquia" id="parroquia" class="form-control @error('parroquia') is-invalid @enderror custom-select">
						<option value="{{$poliza->id_parroquia}}">{{$poliza->parroquia->parroquia}}</option>
					</select>
				...
				<div class="form-group col-md-12">
					...
					<textarea name="client_address" id="client_address" class="form-control @error('client_address') is-invalid @enderror">{{$poliza->client_address}}</textarea>
			...
			<div class="form-row border-bottom border-dark">
				<div class="form-group col-md-6">
					...
					<input  autocomplete="off" type="text" name="vehicleBrand" onkeypress="return check(event)" id="brand" class="form-control @error('vehicleBrand') is-invalid @enderror" value="{{ $poliza->vehicle_brand }}">
					...
					<input  autocomplete="off" type="text" name="vehicleModel" onkeypress="return check(event)" maxlength="25" id="model" class="form-control @error('vehicleModel') is-invalid @enderror" value="{{ $poliza->vehicle_model }}">
					...
					<input  autocomplete="off" type="text" name="vehicle_type" onkeypress="return check(event)" id="vehicle_type" class="form-control @error('vehicle_type') is-invalid @enderror" value="{{ $poliza->vehicle_type }}">
					...
					<input  autocomplete="off" type="number" name="vehicle_year" id="vehicle_year" class="form-control @error('vehicle_year') is-invalid @enderror" value="{{ $poliza->vehicle_year }}">
					...
					<input  autocomplete="off" type="text" name="vehicle_color" id="vehicle_color" class="form-control @error('vehicle_color') is-invalid @enderror" value="{{ $poliza->vehicle_color }}">
					...
					<select id="used_for"   name="used_for" class="form-control @error('used_for') is-invalid @enderror custom-select">
						<option value="{{$poliza->used_for}}">{{$poliza->used_for}}</option>
				...
				<div class="form-group col-md-6">
					...
					<input  autocomplete="off" type="text" name="vehicle_bodywork_serial" id="vehicle_bodywork_serial" class="form-control @error('vehicle_bodywork_serial') is-invalid @enderror" style="text-transform:uppercase;" value="{{ $poliza->vehicle_bodywork_serial }}">
					...
					<input  autocomplete="off" type="text" name="vehicle_motor_serial" id="vehicle_motor_serial" class="form-control @error('vehicle_motor_serial') is-invalid @enderror" style="text-transform:uppercase;" value="{{ $poliza->vehicle_motor_serial }}">
					...
					<input  autocomplete="off" type="number" name="vehicle_certificate_number" id="vehicle_certificate_number" class="form-control @error('vehicle_certificate_number') is-invalid @enderror" style="text-transform:uppercase;" value="{{ $poliza->vehicle_certificate_number }}">
					...
					<input  autocomplete="off" type="text" name="vehicle_registration" id="vehicle_registration" class="form-control @error('vehicle_registration') is-invalid @enderror" style="text-transform:uppercase;" value="{{ $poliza->vehicle_registration }}">
                    ...
                    @enderror
                        <div id="preview-image">
                            ...
                            @if ($poliza->image_tp)
                                <img src="{{ asset('uploads/' . $poliza->id . '/' . $poliza->image_tp) }}" alt="Titulo de Propiedad" style="max-width: 100px; margin-top: 10px;">
                            @endif
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="preview-image1">
                            <!-- Mostrar la imagen existente si está disponible -->
                            @if ($poliza->image_ci)
                                <img src="{{ asset('uploads/' . $poliza->id . '/' . $poliza->image_ci) }}" alt="Cedula o Rif" style="max-width: 100px; margin-top: 10px;">
                            @endif
                        </div>
                    </div>
				</div>
