...
<div class="cuerpo">
    <div class="numeros">
        <p style="font-size: 9px;">
            @if($policy->type== 1)
               <span style="margin-right: 20px;">412-1723470</span>
            <span>424-3492963</span>
            @elseif($policy->type== 2)
               <span style="margin-right: 20px;">414-4861041</span>
            <span>414-4861042</span>
            ...
            @elseif($policy->type== 6)
               <span style="margin-right: 20px;">424-2153632</span>
            ...
            @elseif($policy->type== 9)
             <span style="margin-right: 20px;">412-3053539</span>
         <span>412-3053539</span>
            @endif
