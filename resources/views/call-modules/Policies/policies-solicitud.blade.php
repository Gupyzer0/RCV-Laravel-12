...
@section('module')
<a class="btn btn-primary shadow" href="{{ route('call.index.policies')}}">Polizas</a>
<div class="card shadow mb-4">
	<div class="card-header py-2">
        <h6 class="m-0 font-weight-bold text-primary d-inline-block py-2">Solicitud de Polizas</h6>
		<a class="btn btn-success float-right" href="{{ route('call.register.policy')}}">Nueva Solicitud</a>
	</div>
<div class="navbar navbar-light float-right">
    @if($counter == 0)
  <form class="form-inline" action="{{route('call.search.policies')}}" method="GET">
