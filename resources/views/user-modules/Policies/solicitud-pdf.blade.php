    ...
    <div class="union">
        <table class="borde" style="margin-top: 120px" >
            ...
            <tr>
                ...
                <td colspan="2" width= 25%>{{$policy->client_name_contrator}}</td>
            ...
            <tr>
                ...
                <td colspan="2">{{$policy->client_name}}</td>
                <th>CI/Pasaporte: </th>
        ...
        <table >
            ...
            <tr>
                ...
                <td align="center">{{number_format($policy->price->campoc * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop * $foreign_reference, 2)}} Bs</td>
              </tr>

              <tr>
                <td>{{$policy->price->campo1}} </td>
                <td align="center">{{number_format($policy->price->campoc1 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop1 * $foreign_reference, 2)}} Bs</td>
              </tr>

              @if($policy->price->campo2)
              <tr>
                <td>{{$policy->price->campo2}} </td>
                <td align="center">{{number_format($policy->price->campoc2 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop2 * $foreign_reference, 2)}} Bs</td>
              </tr>
              @else
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="center">{{number_format($policy->price->campoc3 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop3 * $foreign_reference, 2)}} Bs</td>
              </tr>
              @else
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="center">{{number_format($policy->price->campoc4 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop4 * $foreign_reference, 2)}} Bs</td>
              </tr>
              @else
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="center">{{number_format($policy->price->campoc5 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop5 * $foreign_reference, 2)}} Bs</td>
              </tr>
              @else
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="center">{{number_format($policy->price->campoc6 * $foreign_reference, 2)}} Bs</td>
                <td align="center">{{number_format($policy->price->campop6 * $foreign_reference, 2)}} Bs</td>
              </tr>
              @else
              <tr>
                <td>&nbsp;</td>
