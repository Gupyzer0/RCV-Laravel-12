...
<body>
        ...
        <table width="100%" border="0" align="center" style="margin-top:43px;" border:none;" cellspacing="0" bordercolor="#000000" class="borde" >
         ...
         <tr>
            ...
            <tr>
              ...
              <td colspan="2"><strong>Hasta: </strong><i>{{\Carbon\Carbon::parse($policy->expiring_date)->format('d/m/Y')}}</i></td>
              <td ><strong>N° Poliza: </strong><i>{{$policy->id}}</i></td>
          ...
          <tr>
            ...
            <td colspan="2"><strong>Sucursal: </strong><i>{{$policy->user->office->municipio->municipio.', '.$policy->user->office->estado->estado.' '.$policy->user->office->id}}</i></td>
          @elseif($policy->type == 1)
            <td colspan="2" align="center"><strong>Asesor: </strong><i>Eduardo Ortega </i></td>
            <td><strong>Teléfono: </strong><i>0412-1723470</i></td>
            <td colspan="2"><strong>Sucursal: </strong><i>{{$policy->user->office->municipio->municipio.', '.$policy->user->office->estado->estado.' '.$policy->user->office->id}}</i></td>
          @else
            <td colspan="3" align="center"><strong>Asesor: </strong><i>Liliana Tovar</i></td>
            <td><strong>Teléfono: </strong><i>0424-4436226</i></td>
            <td colspan="2"><strong>Sucursal: </strong><i>{{$policy->user->office->office_address}}</i></td>
          ...
          <table width="100%" border="0" align="center" cellspacing="0" bordercolor="#000000" class="borde">
            ...
            <tr>
              ...
              @else
              <td><strong>N° de certificado: </strong>{{$policy->vehicle_certificate_number}}</td></td>
              @endif
            </tr>
          ...
          <table width="100%" border="0" align="center" cellspacing="0" bordercolor="#000000" class="borde">
            ...
            <tr>
              <th colspan="3" style="font-size: 12px; text-align: center;">Descripción del Plan </th>
            </tr>
            ...
            <tr style="font: italic;">
              <td>Daños a cosas: </td>
              <td align="center">{{number_format($policy->damage_things * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium1 * $foreign_reference, 2)}} Bs</td>
            </tr>

            <tr style="font: italic;">
              <td>Daños a personas: </td>
              <td align="center">{{number_format($policy->damage_people * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium2 * $foreign_reference, 2)}} Bs</td>
            </tr>

            <tr style="font: italic;">
              <td>Asistencia jurídica: </td>
              <td align="center">{{number_format($policy->legal_assistance * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium3 * $foreign_reference, 2)}} Bs</td>
            </tr>

            <tr style="font: italic;">
              <td>Muerte: </td>
              <td align="center">{{number_format($policy->death * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium4 * $foreign_reference, 2)}} Bs</td>
            </tr>

            <tr style="font: italic;">
              <td>Invalidez: </td>
              <td align="center">{{number_format($policy->disability * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium5 * $foreign_reference, 2)}} Bs</td>
            </tr>


            <tr style="font: italic;">
              <td>Gastos médicos: </td>
              <td align="center">{{number_format($policy->medical_expenses * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium6 * $foreign_reference, 2)}} Bs</td>
            </tr>
            ...
            <tr style="font: italic;">
              ...
              <td align="center">{{number_format($policy->damage_passengers * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->premium7 * $foreign_reference, 2)}} Bs</td>
              @endif
            </tr>
           <tr style="font: italic;">
                @if($policy->crane == 2)
              <td>Servicio de Grua: </td>
              <td align="center" align="center">25 Km</td>
              <td align="center" align="center">2 Servicios </td>
            ...
            <tr style="font: italic;">
              ...
              <td align="center">{{number_format($policy->total_all * $foreign_reference, 2)}} Bs</td>
              <td align="center">{{number_format($policy->total_premium * $foreign_reference, 2)}} Bs</td>
            </tr>
          </table>
          <br>
          ...
          <table class="firmas" width="100%" border="0" align="center" cellspacing="0" bordercolor="#000000">
            ...
            <tr>
              ...
              <td width="50%" style="font-size: 12px;  text-align: center;">{{$policy->client_name_contractor.' '.$policy->client_lastname_contractor}}</td>
            </tr>

          </table>
<div class="carnet" >
    <table class="tablecarc" style="position: absolute; top: 705px; left: 95px; width: 18%;" cellspacing="0">
...
{{-- carnet 2 --}}
    <table class="tablecarnet2" style="position: absolute; top: 705px; left: 450px; width: 18%;" cellspacing="0">
