...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form action="/user/renew-policy/{{$id}}" method="POST" id="form_policies">
			@csrf
			...
			<div class="form-row border-bottom border-dark">
                ...
                <div class="form-group col-md-3">
					...
					<input required type="date" name="fecha_n" id="fecha_n" value="{{$policy->fecha_n}}" class="form-control @error('fecha_n') is-invalid @enderror">
			...
			<div class="form-row border-bottom border-dark">
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text"  disabled name="vehicleBrand" id="brand" class="form-control @error('vehicleBrand') is-invalid @enderror" placeholder="..." value="{{ $policy->vehicle_brand }}">
					...
					<input autocomplete="off"  disabled type="text" name="vehicleModel" id="model" class="form-control @error('vehicleModel') is-invalid @enderror" placeholder="..." value="{{ $policy->vehicle_model }}">
					...
					<input autocomplete="off"  disabled type="text" name="vehicle_type" id="vehicle_type" class="form-control @error('vehicle_type') is-invalid @enderror" placeholder="..." value="{{ $policy->vehicle_type }}">
					...
					<input autocomplete="off" type="number"  disabled name="vehicle_year" id="vehicle_year" class="form-control @error('vehicle_year') is-invalid @enderror" placeholder="..." value="{{ $policy->vehicle_year }}">
					...
					<select id="used_for" name="used_for"  disabled class="form-control @error('used_for') is-invalid @enderror custom-select">
				...
				<div class="form-group col-md-6">
					...
					<input  disabled autocomplete="off" type="text" name="vehicle_bodywork_serial" id="vehicle_bodywork_serial" class="form-control @error('vehicle_bodywork_serial') is-invalid @enderror" style="text-transform:uppercase;" placeholder="..." value="{{ $policy->vehicle_bodywork_serial }}">
                	...
                	<labe   for="vehicle_certificate_number">Cantidad de Puestos</label>
					...
					<div class="input-group">
						<input autocomplete="off" type="number" disabled name="vehicle_weight" id="vehicle_weight" class="form-control @error('vehicle_weight') is-invalid @enderror" placeholder="Kg" value="{{ $weight_num[0]}}">
			...
			<button id="submitButton" type="submit" class="btn btn-primary btn-block mt-3">Renovar Poliza</button>
		</form>
	</div>
</div>
