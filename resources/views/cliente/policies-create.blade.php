@extends('layouts.client-modules')

@section('module')
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary d-inline-block py-2">Crear de Poliza</h6>


	</div>
	<div class="card-body">

		<form action="" method="POST" id="form_policies">
			@csrf
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					...
					<input required autocomplete="off" type="text" maxlength="40" name="client_lastname_contractor" id="client_lastname_contractor" class="form-control @error('client_lastname_contractor') is-invalid @enderror" placeholder="..." value="{{ old('client_lastname_contractor') }}">
			...
			{{-- Nombre y apellido --}}
				...
				<div class="form-group col-md-6">
					...
					<input required autocomplete="off" type="text" maxlength="40" name="client_lastname" id="client_lastname" class="form-control @error('client_lastname') is-invalid @enderror" placeholder="..." value="{{ old('client_lastname') }}">
			...
			<div class="form-row border-bottom border-dark">
				<div class="form-group col-md-6">
					...
					<input required autocomplete="off" type="text" name="vehicleModel" onkeypress="return check(event)" maxlength="25" id="model" class="form-control @error('vehicleModel') is-invalid @enderror" placeholder="..." value="{{ old('vehicleModel') }}">
				...
				<div class="form-group col-md-6">
                    ...
                    <input required type="text" name="vehicle_registration" readonly id="vehicle_registration" class="form-control @error('vehicle_registration') is-invalid @enderror" style="text-transform:uppercase;" value="" >
			...
			<button id="submitButton" type="submit" class="btn btn-primary btn-block mt-3">Reportar Poliza</button>
		</form>
	</div>
</div>
...
<script>
    ...
    // Obtener el parámetro 'vehicle_registration' y llenar el campo si existe
    document.addEventListener("DOMContentLoaded", function() {
        const vehicleRegistration = getParameterByName("vehicle_registration");
        if (vehicleRegistration) {
            document.getElementById("vehicle_registration").value = vehicleRegistration.toUpperCase();
        }
    });
</script>
@endsection
