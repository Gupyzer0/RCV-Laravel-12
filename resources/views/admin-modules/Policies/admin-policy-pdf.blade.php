...
<body>
        ...
        <table width="100%" border="0" align="center" style="margin-top: 2cm; border:none;" cellspacing="0" bordercolor="#000000" class="borde" >
          ...
          @elseif($policy->type == 3)
            ...
            <td colspan="3" align="center"><strong>Asesor: </strong><i>Asociacion Cooperativa Lider Seguros para Vehiculo RL</i></td>
            <td><strong>Teléfono: </strong><i>0412-9837318</i></td>
          ...
          <table width="100%" border="0" align="center" cellspacing="0" bordercolor="#000000" class="borde">
           ...
           <tr style="font: italic;">
              ...
              <td align="center" align="center">{{number_format($policy->crane * $foreign_reference, 2)}} Bs</td>
