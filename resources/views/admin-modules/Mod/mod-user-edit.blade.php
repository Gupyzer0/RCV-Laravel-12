    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('mod.update.user', $id) }}" id="register_form">
                        @csrf
                        @method('PUT')

                        <div class="form-row border-bottom border-dark">
                            <div class="form-group col-md-6">
                                <label for="names" class="col-form-label text-md-right">Nombre y Apellido</label>
                                <input id="names" type="text" class="form-control @error('names') is-invalid @enderror" name="names" value="{{$user->names}}" autocomplete="off" autofocus>
                            ...
                            <div class="form-group col-md-6">
                                <label for="profi_percentaje" class="col-form-label text-md-right">Porcentaje</label>
                                <input type="text" id="profi_percentaje" name="profi_percentaje" class="form-control @error('profi_percentaje') is-invalid @enderror" value="{{$user->profi_percentaje}}" >
                                @error('profi_percentaje')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                @enderror
                                ...
                                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $user->ci }}</td>
                                            <td><input type="checkbox" name="selected_users[]" value="{{ $user->id }}" {{ in_array($user->id, $selectedUserIds) ? 'checked' : '' }}></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="form-group row mb-0 mt-2">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ URL::previous() }}" class="btn btn-danger" style="width: 90px;">
                                    Volver
                                </a>
                            </div>
                        </div>
