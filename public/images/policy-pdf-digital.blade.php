...
<div class="cuerpo">
    <div class="numeros">
        <p style="font-size: 9px;">
            @if($policy->type== 1)
               <span style="margin-right: 20px;">414-4889333</span>
            <span>414-7654321</span>
            @elseif($policy->type== 2)
               <span style="margin-right: 20px;">414-4861041</span>
            <span>414-7654321</span>
            @elseif($policy->type== 3)
               <span style="margin-right: 20px;">424-3736640</span>
            <span>424-4436226</span>
            @elseif($policy->type== 4)
               <span style="margin-right: 20px;">424-2572272</span>
            <span>412-9961799</span>
            @elseif($policy->type== 5)
               <span style="margin-right: 20px;">424-2572272</span>
            <span>412-9961799</span>
            @elseif($policy->type== 6)
               <span style="margin-right: 20px;">414-2153632</span>
            <span>414-7654321</span>
            @elseif($policy->type== 7)
            <span style="margin-right: 20px;">416-8176295</span>
             <span>416-8176295</span>
            @elseif($policy->type== 8)
               <span style="margin-right: 20px;">414-9032762</span>
            <span>414-9032762</span>
            @elseif($policy->type== 9)
            <span style="margin-right: 20px;">414-4850010</span>
         <span>414-4850010</span>
            @endif
    ...
    <div id="watermark">
            <img src="{{asset('images/contrato.jpg')}}" height="100%" width="100%"/>
        </div>

        <div>
            <h3 style="margin-top: 3cm; font-size: 12px; text-align: center; padding: 0;">CUADRO POLIZA - RECIBO</h3>
        </div>
